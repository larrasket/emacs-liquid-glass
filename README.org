This repo is a small recipe for building Emacs with a Ghostty-like macOS glass frame: =background-opacity = 0.01= with a native =NSGlassEffectView= material. For more information, read the [[https://lr0.org/blog/p/emacs-apple-glass/][blog post]].
